...
@app.task
class RefreshValueMappingsPipeline(Pipeline):

    def run(self, publisher_id_list=[], product_id=None, job_id=None, start_at_stopped_task=False, reprocess_all=False, initiating_user_email=None, run_monthly_job=False, send_alerts=False):
        pipeline_id = "refresh_value_mappings"
