...
#
# def match_authors(reject_first_author, reject_corresponding_author, reject_co_authors_ln_fn, xref_first_author, xref_co_authors_ln_fn, tlogger=None):
#
...
#
#     print('rejected: %s' % rejected_manuscript_author_surnames)
#     print('xref    : %s' % xref_article_author_surnames)
#
...
#             if fuzz.ratio(remove_non_ascii(a), remove_non_ascii(xref_a)) >= 80:
#                 num_match += 1
#                 break
#
#     #print num_match
...
#         authors_match = True
#     elif rejected_manuscript_author_surnames_len == 4 and ratio_match >= 0.75:
#         authors_match = True
