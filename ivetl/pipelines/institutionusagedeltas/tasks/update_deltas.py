...
class UpdateDeltasTask(Task):
    ...
    def run_task(self, publisher_id, product_id, pipeline_id, job_id, work_folder, tlogger, task_args):
        ...
        if publisher_id != 'asm':
            raise Exception('This task only supports ASM currently.')
        ...
        for current_month in utils.month_range(from_date, to_date):
            ...
            for counter_type in ('jr2', 'jr3'):
                ...
                tlogger.info('Processing counter type: %s' % counter_type)
                ...
                for journal in asm_journals:
                    ...
                    for current_usage in session.execute(all_current_month_usage_statement, (publisher_id, counter_type, journal, current_month)):
                        ...
                        tlogger.info('%s, %s, %s' % (current_usage.subscriber_id, current_usage.usage_category, 'm'))
                        ...
                        tlogger.info('%s, %s, %s' % (current_usage.subscriber_id, current_usage.usage_category, 'ytd'))
