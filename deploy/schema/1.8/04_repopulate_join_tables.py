...
if __name__ == "__main__":
    ...
    print('Populating journals...')
    for j in Publisher_Journal_Temporary.objects.all():
    ...
    print('Populating publisher users...')
    for u in Publisher_User_Temporary.objects.all():
